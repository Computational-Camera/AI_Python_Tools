...
libc = ctypes.CDLL("libpyopencv.so.1")
...
t0 = time.time()
ana    = cv2.imread('171206_033057116.png',-1)#16bit gray image
img    = cv2.imread('171206_033057116.jpg') #170927_070150200 171206_033057116
